...
[http://stming.cn/tool/sql2go.html](http://stming.cn/tool/sql2go.html)
##### 2)toml2to 用于将编码后的toml文本转换问golang的struct./
[https://xuri.me/toml-to-go/](https://xuri.me/toml-to-go/)
...
[https://github.com/KyleBanks/depth](https://github.com/KyleBanks/depth)
...
[https://github.com/TrueFurby/go-callvis](https://github.com/mgechev/revive)
##### 10)开发流程改进工具 Realize
...
[https://github.com/40t/go-sniffer](https://github.com/40t/go-sniffer)
##### 5)反向代理工具,快捷开放内网端口.
ngrok 可以让内网服务外部调用.
...
[https://github.com/gojek/weaver](https://github.com/gojek/weaver)
##### 13).进程监控工具 supervisor.
[https://www.jianshu.com/p/39b476e808d8](https://www.jianshu.com/p/39b476e808d8)
...
##### 15).分布式调度工具.
[https://github.com/shunfei/cronsun/blob/master/README_ZH.md](https://github.com/shunfei/cronsun/blob/master/README_ZH.md)
...
[https://konghq.com/careers/#positions](https://konghq.com/careers/#positions)
...
#### 四.常用网站.
##### go百科全书:  [https://awesome-go.com/](https://awesome-go.com/)
##### json解析:  [https://www.json.cn/](https://www.json.cn/)
##### 出口IP:  [https://ipinfo.io/](https://ipinfo.io/)
##### redis命令:  [http://doc.redisfans.com/]( http://doc.redisfans.com/)
##### ES命令首页:   [https://www.elastic.co/guide/cn/elasticsearch/guide/current/index.html](https://www.elastic.co/guide/cn/elasticsearch/guide/current/index.html)
##### UrlEncode:  [http://tool.chinaz.com/Tools/urlencode.aspx](http://tool.chinaz.com/Tools/urlencode.aspx)
##### Base64:  [https://tool.oschina.net/encrypt?type=3]( https://tool.oschina.net/encrypt?type=3)
##### Guid:  [https://www.guidgen.com/](https://www.guidgen.com/)
##### 常用工具:  [http://www.ofmonkey.com/](http://www.ofmonkey.com/)
#### 五.golang常用库.
##### 日志
...
##### 存储
mysql  [https://github.com/go-xorm/xorm](https://github.com/go-xorm/xorm)
es  [[https://github.com/elastic/elasticsearch]( https://github.com/elastic/elasticsearch)
redis   [https://github.com/gomodule/redigo](https://github.com/gomodule/redigo)
mongo  [https://github.com/mongodb/mongo-go-driver](https://github.com/mongodb/mongo-go-driver)
kafka   [https://github.com/Shopify/sarama](https://github.com/Shopify/sarama)
##### 数据结构
...
[https://github.com/benmanns/goworker](https://github.com/benmanns/goworker)
现在我们框架在用的,虽然star不多,但是确实好用,当然还可以更好用.
[https://github.com/rafaeldias/async](https://github.com/rafaeldias/async)

##### 工具
定义了实用的判定类,以及针对结构体的校验逻辑,避免业务侧写复杂的代码.
[https://github.com/asaskevich/govalidator](https://github.com/asaskevich/govalidator)
[https://github.com/bytedance/go-tagexpr](https://github.com/bytedance/go-tagexpr)
##### protobuf文件动态解析的接口,可以实现反射相关的能力.
[https://github.com/jhump/protoreflect](https://github.com/jhump/protoreflect)
##### 表达式引擎工具:
...
##### 字符串处理:
[https://github.com/huandu/xstrings](https://github.com/huandu/xstrings)
##### ratelimit工具:
[https://github.com/uber-go/ratelimit](https://github.com/uber-go/ratelimit)
[https://blog.csdn.net/chenchongg/article/details/85342086](https://blog.csdn.net/chenchongg/article/details/85342086)
...
##### 表格:
[https://github.com/chenjiandongx/go-echarts](https://github.com/chenjiandongx/go-echarts)
##### tail工具库:
[https://github.com/hpcloud/tail](https://github.com/hpcloud/tail)
##### 实用工具:
###### 自动换行库:
[https://github.com/muesli/reflow](https://github.com/muesli/reflow)
###### golang脚本语言:
与golang可以结合的胶水语言比较多:
###### golang原生:
[https://github.com/mattn/anko](https://github.com/mattn/anko)
...
[https://github.com/alexeyco/binder](https://github.com/alexeyco/binder)
...
###### 好用的tengo库
[https://github.com/d5/tengo](https://github.com/d5/tengo)
[https://tengolang.com/?s=0c8d5d0d88f2795a7093d7f35ae12c3afa17bea3](https://tengolang.com/?s=0c8d5d0d88f2795a7093d7f35ae12c3afa17bea3)